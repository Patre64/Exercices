...
<html lang="fr">
    ...
    <body>
        ...
        $results = array(
            array("ville"=>"SAINT-TRIVIER-SUR-MOIGNANS", "departement"=>"01", "latitude"=>"46.0667", "longitude"=>"4.9", "population"=>"1900", "densite"=>"44"),
       ...
       //Trier par ordre alphabetique, les villes:

       //sort($results);//premiere methode
       ...
       usort($results, function($a,$b){
        ...
        <table class = "table table-striped table-dark">
            ...
            <tbody>
	            ...
	            foreach ( $results as $res ) { // Pour chaque ligne (chaque enregistrement)
